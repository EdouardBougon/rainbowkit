...
This wallet connector supports both the Metamask mobile app and extension.

A `parameters` argument is available to add options to metamask connector. Parameters are documented [here](https://docs.metamask.io/wallet/reference/sdk-js-options/).
