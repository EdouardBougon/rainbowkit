...
Un argument `preference` est disponible pour contrôler si Smart Wallet est activé et disponible pour les utilisateurs. Le comportement basé sur les préférences est documenté [ici](https://www.smartwallet.dev/sdk/makeWeb3Provider#parameters).
...
Ce connecteur prend en charge à la fois l’application mobile Metamask et l’extension.

Un argument parameters est disponible pour ajouter des options au connecteur metamask. Les paramètres sont documentés [ici](https://docs.metamask.io/wallet/reference/sdk-js-options/).
